...
// Bone Names
TArray<FString> CCIkBoneRootNames =
{
    "ik_foot_root",
    "ik_hand_root"
};

TArray<FString> CCBoneConvertedNamesUE4 =
{
    "clavicle_l",
    "upperarm_l",
    "lowerarm_l",
...
TArray<FString> CCBoneConvertedNamesUE5 =
{
    "clavicle_l",
    "upperarm_l",
    "lowerarm_l",
...
// CurveNames
TArray<FString> m_kAddHDExpCurvesList =
{
    "HeadControlSwitch",
    "HeadTranslationX",
    "HeadTranslationY",
...
TArray<FString> m_kAddExtendExpCurvesList =
{

...
private:
    ...
    UnrealGeneration CheckBoneStructureGeneration( USkeleton* pAvatarSkeleton );
    ...
    void MoveAssetFolders( TArray<FString>& kAssetFolder, const FString& strTargetFolder );
